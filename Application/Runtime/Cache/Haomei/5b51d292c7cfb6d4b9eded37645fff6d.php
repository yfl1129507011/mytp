        ...
        <div class="nav-selcet">
          <form class="layui-form" action="">
            ...
            <div class="layui-input-block" style="display: none" id="input-checkbox">
              <input type="checkbox" lay-filter="filter" name="like[]" title="李方丁丁丁丁丁">
              <input type="checkbox" lay-filter="filter" name="like[]" title="樱萘">
              <input type="checkbox" lay-filter="filter" name="like[]" title="穆雅斓">
              <input type="checkbox" lay-filter="filter" name="like[]" title="花花ONGAHONG">
              <input type="checkbox" lay-filter="filter" name="like[]" title="王岳鹏Niko">
              <input type="checkbox" lay-filter="filter" name="like[]" title="时髦人绵羊er">
              <input type="checkbox" lay-filter="filter" name="like[]" title="周婷KatieChow">
              <input type="checkbox" lay-filter="filter" name="like[]" title="潘雨润PanYR_"><br/>
              <input type="checkbox" lay-filter="filter" name="like[]" title="陈雪v博">
              <input type="checkbox" lay-filter="filter" name="like[]" title="何慧香">
              <input type="checkbox" lay-filter="filter" name="like[]" title="波克比_">
              <input type="checkbox" lay-filter="filter" name="like[]" title="姚蜜蜜">
              <input type="checkbox" lay-filter="filter" name="like[]" title="小豆蔻儿">
            </div>
            <div class="layui-input-block" id="input-radio">
              <input type="radio" lay-filter="radio-filter" name="like" title="李方丁丁丁丁丁">
              <input type="radio" lay-filter="radio-filter" name="like" title="樱萘">
              <input type="radio" lay-filter="radio-filter" name="like" title="穆雅斓">
              <input type="radio" lay-filter="radio-filter" name="like" title="花花ONGAHONG">
              <input type="radio" lay-filter="radio-filter" name="like" title="王岳鹏Niko">
              <input type="radio" lay-filter="radio-filter" name="like" title="时髦人绵羊er">
              <input type="radio" lay-filter="radio-filter" name="like" title="周婷KatieChow">
              <input type="radio" lay-filter="radio-filter" name="like" title="潘雨润PanYR_"><br/>
              <input type="radio" lay-filter="radio-filter" name="like" title="陈雪v博">
              <input type="radio" lay-filter="radio-filter" name="like" title="何慧香">
              <input type="radio" lay-filter="radio-filter" name="like" title="波克比_">
              <input type="radio" lay-filter="radio-filter" name="like" title="姚蜜蜜">
              <input type="radio" lay-filter="radio-filter" name="like" title="小豆蔻儿">
            </div>
          </form>
        </div>
...
<script>
  ...
  $(function() {
    ...
    //加载PowerBI报表
    var models = window['powerbi-client'].models;
    var staticReportUrl = '<?php echo U("getReportCfg",array("name"=>"drs"));?>';  //获取token的url
