      ...
      <div class="mian-content-box" id="target">
        ...
        <div id="target-label">
          <div class="nav-selcet">
            <span class="used" select-value="1">美妆控</span>
            <span>宅男</span>
            <span>腐女</span>
            <span>极客</span>
            <span>高富帅</span>
...
<script>
  ...
  $(function() {
    ...
    var defaultPageName = 'ReportSection2';    //默认显示页
    ...
    $('.nav-selcet').on('click', 'span', function(){
      if($(this).attr('select-value')) {
        /*$(this).parent().hide();
        $('#reportContainer').css('height', 1375+'px');
        setPage('ReportSection1');*/
        location.href = "<?php echo U('statistics');?>";
      }
    });
